...
ace.num <- revalue(x = data_train$acetohexamide, replace = c("No" = 0, "Steady" = 2))
...
tro.num <- revalue(x = data_train$troglitazone, replace = c("No" = 0, "Steady" = 2))
#suprisingly, "Down" and "Up" were not detected in this column
...
tolz.num <- revalue(x = data_train$tolazamide, replace = c("No" = 0, "Steady" = 2, "Up" = 3))
...
glipm.num <- revalue(x = data_train$glipizide.metformin, replace = c("No" = 0, "Steady" = 2))
...
glip.num <- revalue(x = data_train$glimepiride.pioglitazone, replace = c("No" = 0, "Steady" = 2))
#"Down" and "Up" not present in column
...
metr.num <- revalue(x = data_train$metformin.rosiglitazone, replace = c("No" = 0, "Steady" = 2))
#"Down" and "Up" not present in column
...
metp.num <- revalue(x = data_train$metformin.pioglitazone, replace = c("No" = 0, "Steady" = 2))
#"Down" and "Up" not present in column
